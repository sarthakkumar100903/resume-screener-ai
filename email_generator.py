...
def send_email(to_email, subject, body):
    ...
    password = "rpdsmhgbvppgldjx"  # App password, NOT your Gmail password
...
def send_missing_info_email(to_email, name, missing_fields):
    sender_email = "demoprojectid3@gmail.com"
    sender_password = "rpdsmhgbvppgldjx"  # Use Gmail App Password
